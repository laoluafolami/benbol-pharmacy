...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="relative bg-gradient-to-br from-purple-600 via-indigo-700 to-blue-800 overflow-hidden py-12">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <Heart className="absolute top-10 left-10 w-8 h-8 text-white/20 animate-bounce" style={{ animationDelay: '0s', animationDuration: '3s' }} />
          <Award className="absolute top-20 right-20 w-10 h-10 text-white/20 animate-bounce" style={{ animationDelay: '1s', animationDuration: '4s' }} />
          <Users className="absolute bottom-10 left-1/4 w-6 h-6 text-white/20 animate-bounce" style={{ animationDelay: '2s', animationDuration: '3.5s' }} />
          <Target className="absolute bottom-20 right-1/3 w-7 h-7 text-white/20 animate-bounce" style={{ animationDelay: '0.5s', animationDuration: '4.5s' }} />
        </div>
